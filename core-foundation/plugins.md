...
Cement defines a Plugin Interface, as well as the default [CementPluginHandler](https://cement.readthedocs.io/en/3.0/api/ext/ext\_plugin/#cement.ext.ext\_plugin.CementPluginHandler) that implements the interface.
...
{% code title="myplugin/__init__.py" %}
```python
